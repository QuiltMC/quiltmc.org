...
<div class="columns is-centered">
  <div class="column is-5">
    ...
    **all users of our community (and development) spaces are expected to abide by 
    ...
    <div class="button-grid">
        <a href={config.discordCommunity} target="_blank" class="button is-discord">
        ...
        <a href={`https://twitter.com/${config.twitterUsername}`} target="_blank" class="button is-twitter">
    ...
    is join us on GitHub or the <a href={config.discordToolchain}>Toolchain Discord Server</a>. There’s plenty of things to do, 
    ...
    <div class="button-grid">
        ...
        <a href={`https://github.com/${config.githubUsername}`} target="_blank" class="button is-github">
        ...
        <a href={config.discordToolchain} target="_blank" class="button is-discord">
            <span class="icon"><i class="fab fa-discord"></i></span>
            <span>Toolchain</span>
        </a>
    </div>
