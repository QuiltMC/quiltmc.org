...
<></> {/* prevent annoying MDX bug */}

<Message title="Warning: Outdated Information" style="danger">

**This document needs updating.** As we have migrated from Jekyll to [Astro](https://astro.build), writing documents is now a vastly different process. Please contact [the Dichotomy System](https://github.com/leocth) or [[object Object]](https://github.com/obj-obj) if you need any help writing new articles, while we get the new guidelines ready. Thanks for your patience!
...
* If you prefer, composing in VSCode with [the LanguageTool extension](https://marketplace.visualstudio.com/items?itemName=adamvoss.vscode-languagetool) --
  or IntelliJ IDEA -- will have the same effect as using LanguageTool directly.
