...
This October, Quilt is participating in two open-source contribution challenges: [Hacktoberfest](https://modtoberfest.com) and [Modtoberfest](https://modtoberfest.com). If you want to contribute to Quilt as part of these challenges, thank you so much! We created this guide to help you make the best contributions you can, and maximise your chances of them being accepted.
...
And that is the basics of how to use git and GitHub. If you're interested in learning more about how git works, there is an excellent visual tutorial available at [https://learngitbranching.js.org](https://learngitbranching.js.org). If you get stuck, don't be afraid to ask for help on [Discord](https://discord.quiltmc.org/toolchain).
