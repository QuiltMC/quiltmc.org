...
import HomeAdmonition from "@components/index/HomeAdmonition.astro"
...
<div class="columns is-centered mb-5">
  ...
  <div class="column is-4">
    <HomeAdmonition style="danger" iconType="danger" icon="warning" tKey="wip">
...
<div class="columns mb-5 mt-2">
  <div class="column">
    <HomeAdmonition style="primary is-fullheight" iconType="primary" icon="heart" tKey="caring">
  ...
  <div class="column">
    <HomeAdmonition style="link has-text-left is-fullheight" iconType="link" icon="cubes" tKey="modular">
  ...
  <div class="column">
    <HomeAdmonition style="success has-text-left is-fullheight" iconType="success" icon="wrench" tKey="powerful">
