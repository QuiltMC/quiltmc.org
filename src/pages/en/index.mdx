...
<div class="columns is-centered">
  <div class="column is-5">
    # {t("heading-join-the-community", { ns: "home" })}
    <Trans i18nKey="body-join-the-community" ns="home">
    ...
    # {t("heading-get-involved", { ns: "home" })}
  ...
  <div class="column is-5">
    # {t("heading-latest-posts", { ns: "home" })}
    <LatestPosts />
  </div>
</div>
