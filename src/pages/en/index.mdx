...
<Home content={{}}>
  ...
  <div slot="getInvolved">
    ...
    There are lots of ways you can help us out, even if you aren't a developer.  A list of projects most in need of help can be found on our [Help Wanted page](/en/openings).
