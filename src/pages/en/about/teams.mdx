...
<div class="moderator team-grid">
	<TeamMembers
		list={["AppleTheGolden", "gdude2002", "MrMangoHands", "Leah", "tempest"]}
	/>
</div>
...
<div class="community team-grid">
	<TeamMembers list={["Bubblie", "Fusion", "Lemma", "Octal", "Pyrrha", "Starchild", "TibiNonEst"]} />
</div>
...
<div class="community team-grid">
	<TeamMembers list={["gdude2002", "Southpaw", "Starchild"]} />
</div>
...
<div class="developer team-grid">
	<TeamMembers list={["EnnuiL", "glitch", "TibiNonEst"]} />
</div>
...
<div class="developer team-grid">
	<TeamMembers
		list={["CheaterCodes", "Earthcomputer", "FoundationGames", "Kroppeb", "Pyrofab"]}
	/>
</div>
...
<div class="developer team-grid">
	<TeamMembers list={["gdude2002", "HavenKing", "Southpaw", "Starchild"]} />
</div>
...
<div class="developer team-grid">
	<TeamMembers list={["NoComment", "Octal", "Potatoboy", "SilverAndro", "sschr15"]} />
</div>
...
<div class="developer team-grid">
	<TeamMembers list={["Noah", "snoozestudios", "zOnlyKroks"]} />
</div>
