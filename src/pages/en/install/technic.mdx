...
<noscript>
  <Message>
    ...
    Due to the nature of this page and how the `version.json` file is retrieved, you'll unfortunately need to have JavaScript enabled to download it. Please enable JavaScript and reload the page.
...
<VersionJson />
<script src="/src/util/technic.ts"></script>
