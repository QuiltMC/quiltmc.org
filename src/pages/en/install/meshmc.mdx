---
title: "Install: MeshMC"
permalink: /install/meshmc/

layout: /src/layouts/InstallPage.astro
platformKey: platform-meshmc
website: https://projecttick.org
---

MeshMC is designed to allow users to manage multiple installations of Minecraft at once easily, and provide the power tools an advanced user would need.

To set up a Quilt instance, simply follow these steps:

1. Download and install MeshMC from [their website](https://projecttick.org)
2. Open MeshMC, follow the setup steps and click on the **Add Instance** button at the top of the window
...
To install mods to your MeshMC instance, simply follow these steps:
...
If you can't find the mod you'd like to install using the built-in search, you can simply drag-and-drop any mod files you've downloaded into the mod list, and MeshMC will ensure it's installed properly.
