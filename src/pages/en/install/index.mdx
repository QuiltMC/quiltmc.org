...
<Install content={{ title: "Install", permalink: "/install/" }}>
    ...
    <div slot="awaitingSupport">
        ...
        <Message style="primary" bodyStyle="has-text-left">
            Launchers in this list don't currently support Quilt -- but someone has asked them to, or they're already working on it. You can click on them to find out more about how they're doing -- or how to manually install Quilt with them, where possible.
        </Message>
    </div>
