...
<div class:list={["timeline", rtlSettings().rtl ? "is-rtl" : ""]}>
  ...
  <Item id="2021-02-02" title="2 février 2021" icon="fas fa-wrench">
    ...
    <figure>
      <img alt="i509VCB présente le serveur de l'initiative à ses premiers membres"
  ...
  <Item id="2021-04-17" title="17 avril 2021" icon="fab fa-github">
    ...
    <figure>
      <img alt="i509VCB et Prospector parlent des personnes qui ont trouvé le fork du dépôt Loom."
  ...
  <Item id="2021-04-20" title="20 avril 2021" icon="fas fa-message-smile">
    ...
    <figure>
      <img alt="Earthcomputer et i509VCB partagent des crabes de célébration sur le nouveau serveur Toolchain"
  ...
  <Item id="2021-04-20-later" title="20 avril 2021 (plus tard)" icon="fas fa-pumpkin">
    ...
    <figure>
      <img alt="Les utilisateurs spamment la nouvelle émote Ananas"
  ...
  <Item id="2021-04-22" title="20 avril 2022" icon="fas fa-tags">
    ...
    <figure>
      <img alt="Graphique des nouveaux arrivants sur le Discord du projet Quilt au moment de la sortie de la version bêta"
          src="/assets/img/history/2022-04-20_join-stats.png" />

      <figcaption>
        Graphique des nouveaux arrivants sur le Discord du projet Quilt au moment de la sortie de la version bêta.
      </figcaption>
    </figure>

  </Item>
  <Item id="2023-05-09" title="5 mai 2023" icon="fab fa-discord">
    Quilt met officiellement fin au serveur Discord <a href={site.discordToolchain}>Toolchain</a>, en fusionnant ses canaux avec le serveur Discord <a href={site.discordCommunity}>principal</a>, anciennement le serveur communautaire - dans le but de rapprocher les développeurs des utilisateurs.
