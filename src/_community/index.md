...
We expect everyone that makes use of all Quilt community spaces to adhere to the following rules. If you have any
...
English, but we appreciate that not everyone speaks English at the same level.
...
We provide a number of channels for showcasing and informing users about your Quilt-related projects. Outside these
...
{% comment %}
NOTE: If we decided to go this route, this rule needs to be updated to something like the following.
...
At the end of the day, everyone is here to be themselves in a safe community - to talk about Quilt, or other topics.
We ask that everyone try to exercise empathy and understanding when interacting with other community members and, if
possible, to step away when things get heated.

We all have a responsibility to build the community we'd like to be in, and that starts with thinking about how you
behave here. Together, we can build a safe, inclusive and friendly space for everyone.
{% endcolumn %}
{% endcolumns %}
...
All avatars must adhere to the rules above. Additionally, avatars depicting objectionable or NSFW (Not Safe For Work)
...
member of the community team**. All private reports will be treated with confidentiality.
{% endcolumn %}
{% column "is-half" %}
### Enforcement

Our community team members have multiple tools at their disposal when dealing with rule-breakers, including the 
following:
...
manager as a friend and send your appeal in a private message.
